...
class ScreenOneColor extends StatefulWidget {
  const ScreenOneColor({super.key});

  @override
  _ScreenOneColorState createState() => _ScreenOneColorState();
}

class _ScreenOneColorState extends State<ScreenOneColor> with EventMixinColor<ScreenOneColor> {
  @override
